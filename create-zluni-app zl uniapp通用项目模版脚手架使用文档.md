...
- [4. 命令行参数详解](#4-命令行参数详解)
- [5. 创建流程说明](#5-创建流程说明)
- [6. 模板项目说明（uni-vue3）](#6-模板项目说明uni-vue3)
  - [6.1 技术栈](#61-技术栈)
  - [6.2 项目目录结构](#62-项目目录结构)
  - [6.3 开发与构建命令](#63-开发与构建命令)
  - [6.4 环境变量配置](#64-环境变量配置)
  - [6.5 架构设计](#65-架构设计)
  - [6.6 自定义 Hooks](#66-自定义-hooks)
  - [6.7 业务组件](#67-业务组件)
  - [6.8 工具函数](#68-工具函数)
- [7. 常见开发场景](#7-常见开发场景)
...
通过脚手架创建的项目基于 `uni-vue3` 模板，以下是对模板项目的详细说明。
...
└── src/                          # 源码目录
    ...
    │   ├── uv-button/ ~ uv-upload/ # 60+ uv-ui 组件
    │   ├── z-paging/             # 分页列表
