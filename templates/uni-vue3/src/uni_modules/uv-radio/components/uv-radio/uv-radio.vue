<template>
	<view  @tap.stop="iconClickHandler" :style="customStyle">
		<slot name="custom" :checked="checked" :disabled="elDisabled">
			<view class="uv-radio"
...
<style lang="scss" scoped>
	...
	/* #endif */
	/* #ifdef APP-NVUE */
	@import '@/uni_modules/uv-ui-tools/libs/css/nvue-color.scss';
	/* #endif */
	...
	$uv-radio-checked-background-color: $uv-error !default;
	$uv-radio-checked-border-color: $uv-primary !default;
