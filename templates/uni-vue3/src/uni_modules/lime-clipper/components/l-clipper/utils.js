...
export function calcImageOffset(data, scale) {
	...
	top =
		clipY + clipHeight - currentImageHeight <= top ? top : clipY + clipHeight - currentImageHeight
	return {
		left,
		top,
		scale
...
export function calcImageSize(width, height, data) {
	let imageWidth = width,
		imageHeight = height
	let { clipWidth, clipHeight, sysinfo, width: originWidth, height: originHeight } = data
	if (imageWidth && imageHeight) {
		...
		let sys = sysinfo || uni.getWindowInfo()
